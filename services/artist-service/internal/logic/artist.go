...
func (l *ArtistLogic) CreateArtist(ctx context.Context, req model.CreateArtistRequest) (*model.ArtistResponse, error) {
...
func (l *ArtistLogic) GetArtistByID(ctx context.Context, id string) (*model.ArtistResponse, error) {
...
func (l *ArtistLogic) ListArtists(ctx context.Context, req model.ListArtistRequest) (*model.ListArtistResponse, error) {
	req.Normalize()
...
func (l *ArtistLogic) UpdateArtist(ctx context.Context, id string, req model.UpdateArtistRequest) (*model.ArtistResponse, error) {
	artistID, err := uuid.Parse(id)
	if err != nil {
		return nil, util.NewError(http.StatusBadRequest, 4000, "invalid artist id")
	}
...
func (l *ArtistLogic) DeleteArtist(ctx context.Context, id string) error {
	artistID, err := uuid.Parse(id)
	if err != nil {
