...
import (
	...
	_ "github.com/himbo22/xoxz/livestream-service/docs" // swagger docs
	"github.com/himbo22/xoxz/livestream-service/internal/config"
	"github.com/himbo22/xoxz/livestream-service/internal/di"
...
func main() {
	...
	fmt.Println("Hello, Livestream Service!")
